...
def main(config: DictConfig):
    ...
    valid_augs_list = [load_obj(i['class_name'])(**i['params']) for i in config['augmentation']['valid']['augs']]
    valid_bbox_params = OmegaConf.to_container((config['augmentation']['valid']['bbox_params']))
